/**
 * @file Adc_Config.h
 * @brief Configuration data types for the MCAL ADC module.
 * @details Defines group and module configuration structures consumed by the
 *          ADC initialization service.
 * @req AUTOSAR MCAL ADC configuration concept; project-specific subset.
 */
#ifndef ADC_CONFIG_H
#define ADC_CONFIG_H
#include "Adc_Types.h"
