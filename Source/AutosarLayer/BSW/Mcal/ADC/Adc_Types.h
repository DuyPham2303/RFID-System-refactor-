/**
 * @file Adc_Types.h
 * @brief Common ADC module types, identifiers, and configuration constants.
 * @details Defines the data model shared by the ADC driver, configuration,
 *          and MCU mapping layers.
 * @req AUTOSAR MCAL ADC type definitions; project-specific subset.
 */
