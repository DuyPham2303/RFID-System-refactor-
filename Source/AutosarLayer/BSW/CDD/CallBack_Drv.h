...
Std_ReturnType Brake_RegisterCallBack(uint8 id, CallBack pCb);
Std_ReturnType Pedal_RegisterCallBack(uint8 id, CallBack pCb);
Std_ReturnType Dht11_RegisterCallBack(uint8 id, CallBack pCb);
Std_ReturnType Servo_RegisterCallBack(uint8 id, CallBack pCb);
Std_ReturnType Timer_RegisterCallBack(uint8 id, CallBack pCb);
