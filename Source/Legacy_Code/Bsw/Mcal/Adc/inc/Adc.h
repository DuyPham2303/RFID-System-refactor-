/**
 * @file Adc.h
 * @brief Khai báo giao diện dịch vụ của mô-đun ADC.
 * @details Cung cấp các hàm khởi tạo ADC, thiết lập bộ đệm kết quả
 *          và bắt đầu quá trình chuyển đổi ADC theo nhóm.
 * @req Giao diện được xây dựng dựa trên khái niệm ADC của AUTOSAR MCAL
