/**
 * @file Adc_Config.h
 * @brief Khai báo các kiểu dữ liệu cấu hình cho mô-đun ADC của MCAL.
 * @details Định nghĩa cấu hình cho nhóm ADC và cấu hình chung của mô-đun,
 *          được sử dụng trong quá trình khởi tạo và vận hành ADC.
 * @req Tuân theo khái niệm cấu hình ADC của AUTOSAR MCAL
 *      và các yêu cầu cấu hình riêng của dự án.
 */
