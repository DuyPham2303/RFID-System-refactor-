/**
 * @file Dio.h
 * @brief MCAL Digital Input/Output driver interface.
 * @details Declares DIO types, channel identifiers, and services used to
 *          access digital ports and channels.
 * @req AUTOSAR MCAL DIO module; implementation is MCU dependent.
 */
/********************************************************
 *******************
 * @file Std_Types.h
