/**
 * @file Port.h
 * @brief MCAL Port driver interface.
 * @details Declares port, pin, mode, speed, and configuration types and
 *          services used to configure MCU pins.
 * @req AUTOSAR MCAL PORT module; implementation is MCU dependent.
 */
#ifndef PORT_H
#define PORT_H
#include "Std_Types.h"
