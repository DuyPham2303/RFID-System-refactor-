...
inline uint8 GetChannelAdc(Adc_ChannelType ChannelId)
{
	switch (ChannelId)
	{
	case ADC_AUTOSAR_CHANNEL_0:
		return ADC_Channel_0;
	case ADC_AUTOSAR_CHANNEL_1:
		return ADC_Channel_1;
	case ADC_AUTOSAR_CHANNEL_2:
		return ADC_Channel_2;
	case ADC_AUTOSAR_CHANNEL_3:
		return ADC_Channel_3;
	case ADC_AUTOSAR_CHANNEL_4:
		return ADC_Channel_4;
	// case ADC_AUTOSAR_CHANNEL_5:	return ADC_Channel_5;
	case ADC_AUTOSAR_CHANNEL_6:
		return ADC_Channel_6;
	case ADC_AUTOSAR_CHANNEL_7:
		return ADC_Channel_7;
	case ADC_AUTOSAR_CHANNEL_8:
		return ADC_Channel_8;
	case ADC_AUTOSAR_CHANNEL_9:
		return ADC_Channel_9;
	case ADC_AUTOSAR_CHANNEL_10:
		return ADC_Channel_10;
	case ADC_AUTOSAR_CHANNEL_11:
		return ADC_Channel_11;
	case ADC_AUTOSAR_CHANNEL_12:
		return ADC_Channel_12;
	case ADC_AUTOSAR_CHANNEL_13:
		return ADC_Channel_13;
	case ADC_AUTOSAR_CHANNEL_14:
		return ADC_Channel_14;
	case ADC_AUTOSAR_CHANNEL_15:
		return ADC_Channel_15;
	case ADC_AUTOSAR_CHANNEL_16:
...
inline uint8 GetSamplingTime(Adc_SamplingTimeType T_sampling)
{
	switch (T_sampling)
	{
	case ADC_AUTOSAR_SAMPLING_1CYCLE:
		return ADC_SampleTime_1Cycles5;
	case ADC_AUTOSAR_SAMPLING_7CYCLE:
		return ADC_SampleTime_7Cycles5;
	case ADC_AUTOSAR_SAMPLING_13CYCLE:
		return ADC_SampleTime_13Cycles5;
	case ADC_AUTOSAR_SAMPLING_28CYCLE:
		return ADC_SampleTime_28Cycles5;
	case ADC_AUTOSAR_SAMPLING_41CYCLE:
		return ADC_SampleTime_41Cycles5;
	case ADC_AUTOSAR_SAMPLING_55CYCLE:
		return ADC_SampleTime_55Cycles5;
	case ADC_AUTOSAR_SAMPLING_71CYCLE:
		return ADC_SampleTime_71Cycles5;
	case ADC_AUTOSAR_SAMPLING_239CYCLE:
								  ...
								  Adc_HwTriggerTimerType TriggerSourceHw)
{
	...
	{
		if (TriggerSourceHw == ADC_AUTOSAR_EXT_TRIG_CONV_T1_CC1)
			return ADC_ExternalTrigConv_T1_CC1;
		else if (TriggerSourceHw == ADC_AUTOSAR_EXT_TRIG_CONV_T1_CC2)
			return ADC_ExternalTrigConv_T1_CC2;
		else if (TriggerSourceHw == ADC_AUTOSAR_EXT_TRIG_CONV_T1_CC2)
			return ADC_ExternalTrigConv_T2_CC2;
		else
...
{
	if (NumOfGroup > 1)
		return ADC_Mode_Independent;
	else
	{
		if (IsInjected)
			return ADC_Mode_RegSimult;
		else
			return ADC_Mode_InjecSimult;
	}
}
inline uint32 GetAdcClock(Adc_PrescaleType prescaler)
{
	switch (prescaler)
	{
	case ADC_AUTOSAR_PRESCALE_DIV2:
		return RCC_PCLK2_Div2;
	case ADC_AUTOSAR_PRESCALE_DIV4:
		return RCC_PCLK2_Div4;
	case ADC_AUTOSAR_PRESCALE_DIV6:
		return RCC_PCLK2_Div6;
	case ADC_AUTOSAR_PRESCALE_DIV8:
