 ...
 * @return  `E_OK` n?u buffer du?c thi?t l?p thành công, `E_NOT_OK` n?u có l?i.
 * @note    - Buffer ph?i có kích thu?c d? d? ch?a t?t c? d? li?u ADC c?a nhóm.
 *          - Ph?i g?i hàm này tru?c khi b?t d?u chuy?n d?i nhóm (`Adc_StartGroupConversion`).
 */
